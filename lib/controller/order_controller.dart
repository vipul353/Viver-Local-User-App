...
class OrderController extends GetxController implements GetxService {
  ...
  XFile _refundImage;
  String _codpaymenttype = "";
  String _paymentcodtype = "";
  ...
  String get codpaymenttype => _codpaymenttype;
  String get paymentcodtype => _paymentcodtype;
  ...
  void setCODPaymentMethod(String index) {
    _codpaymenttype = index;
    update();
  }

  void setPaymentCODMethod(String index) {
    _paymentcodtype = index;
    update();
  }
